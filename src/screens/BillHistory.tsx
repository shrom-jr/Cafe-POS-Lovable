  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-3 max-w-2xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground" data-testid="text-bills-count">{filtered.length} bills found</p>

        <div className="space-y-2">
          {filtered.map((p) => (
            <div key={p.id} className="bg-card rounded-xl border border-border overflow-hidden" data-testid={`bill-card-${p.id}`}>
              <button
